...
<main role="main" class="container">
    <div class="col-lg-12" style="text-align: center;">
        <h1><spring:message code="title.auditor.meus.dados" /></h1>
    </div>
    <div class="col-lg-8 offset-lg-2">
        <form id="formAdministradorDados" action="<c:out value="${pageContext.request.contextPath}"></c:out>/auditor/dados/update" method="POST">
            <div class="form-row">
                <div class="col-lg-12" style="text-align: center;">
                    <hr>
                    <h4><spring:message code="subtitle.auditor.meus.dados" /></h4>
                    <hr>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <i id="tooltipNome" class="tooltiphelper material-icons md-18" data-toggle="tooltip" data-placement="right" title="<spring:message code="tooltip.auditor.dados.nome" />">help_outline</i>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <i id="tooltipEmail" class="tooltiphelper material-icons md-18" data-toggle="tooltip" data-placement="right" title="<spring:message code="tooltip.auditor.dados.email" />">help_outline</i>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <i id="tooltipPerfil" class="tooltiphelper material-icons md-18" data-toggle="tooltip" data-placement="right" title="<spring:message code="tooltip.auditor.dados.perfil" />">help_outline</i>

...
<main role="main" class="container">
    <div class="col-lg-12" style="text-align: center;">
        <h1><spring:message code="title.instituicao.meus.dados" /></h1>
    </div>
    <div class="col-lg-10 offset-lg-1">
        <form id="formInstituicaoGet" action="<c:out value="${pageContext.request.contextPath}"></c:out>/instituicao/dados/update" method="POST" enctype="multipart/form-data">
            <div class="form-row">
                <div class="col-lg-12" style="text-align: center;">
                    <hr>
                    <h4><spring:message code="subtitle.instituicao.meus.dados" /></h4>
                    <hr>
                </div>
                <div class="form-group" style="display: none">
                    <label for="id"><spring:message code="label.instituicao.id" /></label>
                    <input type="text" class="form-control" id="id" name="id" value="<c:out value="${instituicaoLogado.id}"/>" readonly>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" value="<c:out value="${instituicaoLogado.nome}"/>" readonly>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" class="form-control cnpj" id="cnpj" name="cnpj" value="<c:out value="${instituicaoLogado.cnpj}"/>" readonly>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <input type="email" class="form-control" id="email" name="email" value="<c:out value="${instituicaoLogado.email}"/>">
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" class="form-control" id="site" name="site" value="<c:out value="${instituicaoLogado.site}"/>">
                </div>
                <div class="form-group col-lg-3">
                    ...
                    <input type="text" class="form-control" id="anoFundacao" name="anoFundacao" value="<c:out value="${instituicaoLogado.anoFundacao}"/>">
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <select class="form-control" id="administracao" name="administracao">
                        <option value="<c:out value="${instituicaoLogado.administracao.id}"/>" selected="selected">
                            <c:out value="${instituicaoLogado.administracao.administracao}" />
                        </option>
                        <c:forEach items="${listaDeAdministracao}" var="administracao">
                            <c:if test="${instituicaoLogado.administracao.id != administracao.id}">
                                <option value="<c:out value="${administracao.id}"/>">
                                    <c:out value="${administracao.administracao}" />
                                </option>
                            </c:if>
                        </c:forEach>
                    </select>
                ...
                <div class="form-group col-lg-3">
                    ...
                    <input type="text" class="form-control" id="quantidadeAluno" name="quantidadeAluno" value="<c:out value="${instituicaoLogado.quantidadeAluno}"/>">
                </div>
                <div class="form-group col-lg-3">
                    ...
                    <input type="text" class="form-control" id="quantidadeProfessor" name="quantidadeProfessor" value="<c:out value="${instituicaoLogado.quantidadeProfessor}"/>">
                </div>
                <div class="form-group col-lg-3">
                    ...
                    <input type="text" class="form-control" id="quantidadePessoalApoio" name="quantidadePessoalApoio" value="<c:out value="${instituicaoLogado.quantidadePessoalApoio}"/>">
                </div>
                <div class="form-group col-lg-3">
                    ...
                    <input type="text" class="form-control" id="quantidadeTurma" name="quantidadeTurma" value="<c:out value="${instituicaoLogado.quantidadeTurma}"/>">
                </div>
                <div class="form-group col-lg-3">
                    ...
                    <input type="text" class="form-control" id="quantidadeAmbienteDidatico" name="quantidadeAmbienteDidatico" value="<c:out value="${instituicaoLogado.quantidadeAmbienteDidatico}"/>">
                </div>
                <c:forEach items="${instituicaoLogado.telefone}" var="telefone" varStatus="count">
                ...
                <div class="col-lg-12" style="text-align: center;">
                    <hr>
                    <h4><spring:message code="subtitle.instituicao.meus.dados.endereco" /></h4>
                    <hr>
                </div>
                <div class="form-group col-lg-2">
                    ...
                    <input type="text" class="form-control cep_with_callback" id="endereco.cep" name="endereco.cep" value="<c:out value="${instituicaoLogado.endereco.cep}"/>" readonly>
                </div>
                <div class="form-group col-lg-10">
                    ...
                    <input type="text" class="form-control" id="endereco.logradouro" name="endereco.logradouro" value="<c:out value="${instituicaoLogado.endereco.logradouro}"/>" readonly>
                </div>
                <div class="form-group col-lg-2">
                    ...
                    <input type="text" class="form-control" id="endereco.numero" name="endereco.numero" value="<c:out value="${instituicaoLogado.endereco.numero}"/>" readonly>
                </div>
                <div class="form-group col-lg-4">
                    ...
                    <input type="text" class="form-control" id="endereco.cidade" name="endereco.cidade" value="<c:out value="${instituicaoLogado.endereco.cidade}"/>" readonly>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" class="form-control" id="endereco.uf" name="endereco.uf" value="<c:out value="${instituicaoLogado.endereco.uf}"/>" readonly>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" class="form-control" id="endereco.bairro" name="endereco.bairro" value="<c:out value="${instituicaoLogado.endereco.bairro}"/>" readonly>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" class="form-control" id="endereco.pais" name="endereco.pais" value="<c:out value="${instituicaoLogado.endereco.pais}"/>" readonly>
                </div>
                <div class="col-lg-12" style="text-align: center;">
                    <hr>
                    <h4><spring:message code="subtitle.instituicao.meus.dados.representante" /></h4>
                    <hr>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" class="form-control" id="representante.nome" name="representante.nome" value="<c:out value="${instituicaoLogado.representante.nome}"/>">
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <input type="email" class="form-control" id="representante.email" name="representante.email" value="<c:out value="${instituicaoLogado.representante.email}"/>">
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <select class="form-control" id="representante.escolaridade" name="representante.escolaridade">
                        <option value="<c:out value="${instituicaoLogado.representante.escolaridade.id}"/>" selected="selected">
                            <c:out value="${instituicaoLogado.representante.escolaridade.escolaridade}" />
                        </option>
                        <c:forEach items="${listaDeEscolaridade}" var="escolaridade">
                            <c:if test="${escolaridade.id != instituicaoLogado.representante.escolaridade.id}">
                                <option value="<c:out value="${escolaridade.id}"/>">
                                    <c:out value="${escolaridade.escolaridade}" />
                                </option>
                            </c:if>
                        </c:forEach>
                    </select>
                ...
                <div class="form-group col-lg-3">
                    ...
                    <input type="text" class="form-control" id="representante.tempoInstituicao" name="representante.tempoInstituicao" value="<c:out value="${instituicaoLogado.representante.tempoInstituicao}"/>">
                </div>
                <div class="form-group col-lg-3">
                    ...
                    <input type="text" class="form-control" id="representante.tempoCargo" name="representante.tempoCargo" value="<c:out value="${instituicaoLogado.representante.tempoCargo}"/>">
                </div>
                <div class="form-group col-lg-12" id="divRepresentanteDocumentoVisualizar">
                    ...
                    <a href="<c:out value="${pageContext.request.contextPath}"></c:out>/instituicao/docviewer/" class="linkcustom"><i id="tooltipRepresentanteDocumentoVisualizar" class="cursorpointer material-icons md-18" data-toggle="tooltip" data-placement="right" title="<spring:message code="tooltip.instituicao.dados.representante.documento.de.nomeacao.visualizar" />">insert_photo</i></a>
                        ...
                        <input type="text" class="form-control" id="representante.documento.nome" name="representante.documento.nome" value="<c:out value="${instituicaoLogado.representante.documento.nome}"/>" readonly disabled>
                </div>
                ...
                <div class="col-lg-12" style="text-align: center;">
                    <c:if test="${emCurso eq true}">
                        <button type="submit" class="btn btn-primary" disabled data-toggle="tooltip" data-placement="right" title="Esta funcionalidade é desativada enquanto houver um período de avaliações em andamento."><spring:message code="button.atualizar" /></button>
                    </c:if>
                    <c:if test="${emCurso eq false}">
